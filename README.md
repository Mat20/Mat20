...
:floppy_disk: Database: **Postgres**, **Mongo**,**Firebase**, **SQL Server**, **MySQL** <br/>
...
:mortar board: I have a degree in Information Systems, a postgraduate degree in hours on Youtube (Google).



I also love **UX Design** :heart_eyes:. I like to create beautiful interfaces to provide the user with a great experience. To create prototypes I use **Figma**.
